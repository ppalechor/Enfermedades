...
function create(_a) {
    return __awaiter(this, arguments, void 0, function* ({ nombre_epa, descripcion, imagen }) {
        const result = yield db_1.default.query('INSERT INTO epa (nombre_epa, descripcion, imagen) VALUES ($1, $2, $3) RETURNING *', [nombre_epa, descripcion, imagen]);
        return result.rows[0];
    });
}
